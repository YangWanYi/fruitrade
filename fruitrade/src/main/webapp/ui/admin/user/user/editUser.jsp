...
<html>
	...
	<body>
		<form id="myForm">
			...
			<div class="form-group row">
			    ...
			    <div class="col-sm-6">
			      <input type="text" class="form-control" id="colFormLabelSm" name="account" value="${requestScope.userData.account}" placeholder="请输入登录账号">
			    </div>
			</div>
			<div class="form-group row">
			...
			<div class="form-group row">
			    ...
			    <div class="col-sm-10">
			      <input type="text" class="form-control" id="colFormLabelSm" name="userName" value="${requestScope.userData.userName}" placeholder="请输入您的姓名">
			    </div>
			</div>
			<div class="form-group row">
			...
			<div class="form-group row">
			    ...
			    <div class="col-sm-10">
			      <input type="tel" class="form-control" id="colFormLabelSm" name="phoneNum" value="${requestScope.userData.phoneNum}" placeholder="请输入手机号">
			    </div>
			</div>
			<div class="form-group row">
			...
			<div class="form-group row">
			    ...
			    <div class="col-sm-10">
			      <input type="text" class="form-control" id="colFormLabelSm" name="address" value="${requestScope.userData.address}" placeholder="请输入收货地址">
			    </div>
			</div>
		</form>
	</body>
	...
	<script type="text/javascript">
		$(function(){
			...
			$('#roleId').find('option[value="${requestScope.userData.roleId}"]').attr('selected','selected'); //角色回显
		});
	</script>
</html>
