...
<html>
	...
	<body>
		...
		<div class="searchItem">
			<span>货架地址</span>
		    <input type="text" class="form-control" style="width: 160px;margin-top:5px;"  id="address" value="" placeholder="请输入货架地址">
			<span>负责人</span>
	...
	<script type="text/javascript">
		...
		$('#searchStorage').click(function(){ // 立即搜索
			...
			initTable('/listStorage.action?address='+address+'&principal='+principal);
		});
