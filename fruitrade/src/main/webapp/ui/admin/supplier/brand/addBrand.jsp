	...
	<body>
		<form id="myForm" role="form">
			<div class="form-group row">
			    ...
			    <div class="col-sm-6">
			      <input type="text" class="form-control" id="colFormLabelSm" name="brandName" value="" placeholder="请输入品牌名称">
			    </div>
			</div>
			<div class="form-group row">
			    <label for="colFormLabelSm" class="col-sm-2 col-form-label">品牌编号</label>
			    <div class="col-sm-6">
			      <input type="text" class="form-control" id="colFormLabelSm" name="brandCode" value="" placeholder="请输入品牌编号">
			    </div>
			</div>
			<div class="form-group row">
			...
			<div class="form-group row">
			    ...
			    <div class="col-sm-10">
			      <input type="tel" class="form-control" id="colFormLabelSm" name="contactNum" value="" placeholder="请输入联系电话">
			    </div>
			</div>
			<div class="form-group row">
			    <label for="colFormLabelSm" class="col-sm-2 col-form-label">公司所在地</label>
			    <div class="col-sm-6">
			     <textarea class="form-control" id="exampleFormControlTextarea1" name="address" rows="3" placeholder="请输入公司所在地"></textarea>
			    </div>
			</div>
		</form>
	</body>
