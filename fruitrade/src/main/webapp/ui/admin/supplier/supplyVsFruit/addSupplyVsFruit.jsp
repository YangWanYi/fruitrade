	...
	<body>
		<form id="myForm" role="form">
			...
			<div class="form-group row">
			    ...
			    <div class="col-sm-6">
			     <textarea class="form-control" id="exampleFormControlTextarea1" name="place" rows="9" placeholder="请输入产地"></textarea>
			    </div>
			</div>
			<div class="form-group row">
			    <label for="colFormLabelSm" class="col-sm-2 control-label">批发价</label>
			    <div class="col-sm-7 input-group">
			      <input type="number" class="form-control" id="price" name="price" value="" placeholder="请输入批发价">
			    </div>
			</div>
			<div class="form-group row">
