...
<html>
	...
	<body>
		<form id="myForm">
			<input type="hidden" name="id" value="${requestScope.purchaseMap.id}">
			<input type="hidden" name="createId" value="${requestScope.purchaseMap.createId}">
			<input type="hidden" name="createTime" value="${requestScope.purchaseMap.createTime}">
			<input type="hidden" id="supplyVsFruitId" name="supplyVsFruitId" value="${requestScope.purchaseMap.supplyVsFruitId}"/>
			...
			<div class="form-group row">
			    ...
			    <div class="col-sm-7 input-group">
					<select class="form-control" name="fruitId" id="fruitId" onChange="loadFruitPlace(value);">
			...
			<div class="form-group row">
			    ...
			    <div class="col-sm-7 input-group">
			      <input type="text" class="form-control" id="place" name="place" value="${requestScope.purchaseMap.place}" placeholder="请输入产地">
			    </div>
			</div>
			<div class="form-group row">
			    <label for="colFormLabelSm" class="col-sm-2 control-label">批发价</label>
			    <div class="col-sm-7 input-group">
			      <input type="text" class="form-control" id="price" name="price" value="${requestScope.purchaseMap.price}" placeholder="请输入批发价">
			    </div>
			</div>
			<div class="form-group row">
			    <label for="colFormLabelSm" class="col-sm-2 control-label">批发单位</label>
			    <div class="col-sm-7 input-group">
			      <input type="text" class="form-control" id="unit" name="unit" value="${requestScope.purchaseMap.unit}" placeholder="请输入批发单位">
			    </div>
			</div>
			<div class="form-group row">
			    <label for="colFormLabelSm" class="col-sm-2 control-label">进货数量</label>
			    <div class="col-sm-7 input-group">
			      <input type="number" class="form-control" id="purchaseNum" name="purchaseNum" value="${requestScope.purchaseMap.purchaseNum}" placeholder="请输入进货数量">
			    </div>
			</div>
			<div class="form-group row">
			    <label for="colFormLabelSm" class="col-sm-2 control-label">售价</label>
			    <div class="col-sm-7 input-group">
			      <input type="number" class="form-control" id="salePrice" name="salePrice" value="${requestScope.purchaseMap.salePrice}" placeholder="请输入售价">
			    </div>
			</div>
			<div class="form-group row">
	...
	<script type="text/javascript">
				...
				success: function(s){
					...
					if(s.total>0){
						$(s.rows).each(function(m,n){
							...
							if(str.indexOf(n.classifyName)==-1){
		...
		$('#supplyType').find('option[value="${requestScope.purchaseMap.supplyType}"]').attr('selected','selected');
		$('#storeHouseId').find('option[value="${requestScope.purchaseMap.storeHouseId}"]').attr('selected','selected');
		$('#storageId').find('option[value="${requestScope.purchaseMap.storageId}"]').attr('selected','selected');
		$('#supplyId').find('option[value="${requestScope.purchaseMap.supplyId}"]').attr('selected','selected');
		$('#classifyId').find('option[value="${requestScope.purchaseMap.classifyId}"]').attr('selected','selected');
		$('#fruitId').find('option[value="${requestScope.purchaseMap.fruitId}"]').attr('selected','selected');
	</script>
</html>
