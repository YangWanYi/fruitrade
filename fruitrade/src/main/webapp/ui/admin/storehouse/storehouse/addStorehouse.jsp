	...
	<body>
		<form id="myForm" role="form">
			<div class="form-group row">
			    ...
			    <div class="col-sm-6">
			      <input type="text" class="form-control" id="colFormLabelSm" name="storeHouseCode" value="" placeholder="请输入仓库编号">
			    </div>
			</div>
			<div class="form-group row">
			...
			<div class="form-group row">
			    ...
			    <div class="col-sm-10">
			      <input type="text" class="form-control" id="colFormLabelSm" name="contactNum" value="" placeholder="请输入联系方式">
			    </div>
			</div>
			<div class="form-group row">
			    <label for="colFormLabelSm" class="col-sm-2 col-form-label">仓库地址</label>
			    <div class="col-sm-6">
			     <textarea class="form-control" id="exampleFormControlTextarea1" name="address" rows="3" placeholder="请输入仓库地址"></textarea>
			    </div>
			</div>
		</form>
	</body>
