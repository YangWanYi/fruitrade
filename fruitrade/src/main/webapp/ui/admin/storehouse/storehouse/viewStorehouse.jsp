	...
	<body>
		<form id="myForm">
			...
			<div class="form-group row">
			    ...
			    <div class="col-sm-6">
			      <input type="text" class="form-control" id="colFormLabelSm" name="address" value="${requestScope.storehouseData.address}" placeholder="请输入仓库地址">
			    </div>
			</div>
			<div class="form-group row">
			    <label for="colFormLabelSm" class="col-sm-2 col-form-label">货架</label>
			    <div class="col-sm-6">
			      <input type="text" class="form-control" id="colFormLabelSm" name="storageCode" value="${requestScope.storehouseData.storageCode}" placeholder="请输入货架">
			    </div>
			</div>
			<div class="form-group row">
			...
			<div class="form-group row">
			    ...
			    <div class="col-sm-10">
			      <input type="tel" class="form-control" id="colFormLabelSm" name="contactNum" value="${requestScope.storehouseData.contactNum}" placeholder="请输入联系方式">
			    </div>
			</div>
		</form>
	</body>
